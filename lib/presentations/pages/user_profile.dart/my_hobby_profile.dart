...
class _MyHobbyProfileState extends State<MyHobbyProfile> {
  ...
  void initState() {
    ...
    isNotificationEnabled = settingsBox.get(
      'notifications',
      defaultValue: false,
    );
  }
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      final hasInteracted = box.get(
                                        'hasInteractedWithSwitch',
                                        defaultValue: false,
                                      );
                                      ...
                                      if (!hasInteracted) {
                                        ...
                                        if (isGranted) {
                                          ...
                                          _showNotificationInfoDialog(
                                            ...
                                            message:
                                                "Allow access in Settings. This will help you set reminder 1 day before due date of your task",
                                          );
                                        }
                                      } else {
                                        setState(() {
